...
import unittest
from model.user import User  # Assure-toi d'importer correctement la classe User
...
class TestUser(unittest.TestCase):
    ...
    def test_creation_user(self):
        # Vérifier que le user a été créé avec les attributs corrects
        ...
        self.assertAlmostEqual((self.user.updated_at - self.user.created_at).total_seconds(), 0, delta=1)

    def test_add_review(self):
        # Ajouter une critique et vérifier qu'elle est correctement ajoutée à la liste des critiques
        review = {"review_id": "review123", "rating": 5, "comment": "Great experience!"}
    ...
    def test_to_dict(self):
        ...
        # Vérifier que les valeurs du dictionnaire correspondent aux attributs du user
    ...
    # Tu peux ajouter d'autres tests pour les autres méthodes de la classe User ici...
