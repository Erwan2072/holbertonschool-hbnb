...
"""Define a namespace for amenities-related operations"""
...
class Amenities(Resource):
    ...
    def post(self):
        """Create a new amenity.
            Generate a unique ID for the new amenity
            Set the current datetime as created_at
            Set the current datetime as updated_at
            Save the new amenity using data manager
        """
...
class AmenityResource(Resource):
    ...
    def get(self, amenity_id):
        """Fetch an amenity by its ID.
            Get amenity data by ID
            Return amenity data if found
            Return 404 error if amenity not found
        """
